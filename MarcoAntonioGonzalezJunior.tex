...
Ready to solve your most complex enterprise AI challenges and deliver measurable business impact. \\
\vspace{0.5mm}
%==== Skills ====%
\header{Skills}
\vspace{0.5mm}
...
\vspace{0.5mm}
Architected enterprise AI solutions, designing foundation model fine-tuning pipelines and advanced RAG systems with continuous learning capabilities for financial services clients.
\vspace{-2mm}
\begin{itemize}
\setlength\itemsep{-1mm}
