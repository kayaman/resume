...
\begin{center}
    ...
    \vspace{2.5pt}
    linkedin.com/in/marcoantoniogonzalezjunior              \\
    \vspace{1.25mm}
    \textbf{Solutions Architect | Cloud Engineer | AI Engineer}
\end{center}
\vspace{-1.5mm}
%==== Professional Summary ====%
\header{Professional Summary}
Solutions Architect with 15+ years building scalable enterprise systems and 10+ years in AI/ML. Led technical teams delivering solutions that generated 30\% revenue increases and 200\% improvement in customer retention across financial, retail, and digital marketing. Currently specializing in advanced generative AI: custom model development and fine-tuning, RAG, agentic workflows, multi-agent systems, tool-use optimization, responsible AI development and enterprise AI governance. \\
\vspace{0.5mm}
%==== Skills ====%
\header{Skills}
\vspace{0.5mm}
...
\textbf{Cloud \& DevOps:} AWS/Azure/GCP, Kubernetes, Docker, Terraform, CI/CD
...
\textit{Senior Solutions Architect - Artificial Intelligence}               \hfill September 2025 \raisebox{0.2ex}{\scalebox{0.8}{$\sim$}} present    \\
\vspace{0.5mm}
Leading technically innovative AI projects throughout the 
\vspace{-2mm}
\begin{itemize}
\setlength\itemsep{-1mm}
\item Collaborating with AI/ML scientists and architects to research, design, develop, and evaluate generative AI solutions to address real-world challenges
\item Interacting with internal customers directly to understand their business problems, aid them in implementation of generative AI solutions, brief customers and guide them on adoption patterns and paths to production
\item Implementing MLOps and LLMOps CI/CD pipelines on top of Databricks and Azure to serve foundation and fine-tuned models to power creation of agentic systems, specialized from monitoring customer support to custom code review agents
\item Implementing a centralized AI Gateway to provide model access with fallbacks, spend tracking, rate limiting, security and prompt caching, among other several essential features
\end{itemize}

%======== Capco ========%
\textbf{Capco}                                                    \hfill São Paulo              \\
\textit{Senior Solutions Architect - Artificial Intelligence}               \hfill September 2024 \raisebox{0.2ex}{\scalebox{0.8}{$\sim$}} September 2025    \\
\vspace{0.5mm}
Led AI-driven legacy modernization initiatives using knowledge graphs and LLMs to transform legacy enterprise COBOL systems into modern technology stacks.
\vspace{-2mm}
\begin{itemize}
\setlength\itemsep{-1mm}
...
\item Engineered production RAG systems combining semantic search (Pinecone, Weaviate) and knowledge graphs (Neo4j) to achieve 90\% fidelity in preserving business logic during legacy COBOL migration to Java/.NET
...
\textit{Senior Solutions Architect - Artificial Intelligence} \hfill July 2022 \raisebox{0.2ex}{\scalebox{0.8}{$\sim$}} September 2023 \
\vspace{0.5mm}
Architected advanced AI solutions for financial services clients, including foundation models fine-tuning and hybrid RAG systems with continuous learning capabilities, to improve customer support systems.
\vspace{-2mm}
\begin{itemize}
\setlength\itemsep{-1mm}
\item Fine-tuned multiple custom models (LLMs) specialized to business domain. through fine-tuning pipelines and RAG knowledge bases using PyTorch, and TensorFlow, resulting in an automated resolution rate above 75\% and 25\% improvement in customer satisfaction.
\item Designed a multi-cloud MLOps platform (AWS, Azure) with automated continuous learning pipelines, ensuring 99\% uptime while serving 10M+ monthly interactions.
\item Developed a comprehensive model evaluation framework integrating BERTScore-based semantic analysis and human-in-the-loop feedback, enabling continuous model refinement that kept knowledge base up-to-date under strict security and compliance constraints.
